---
description: Compatibility shim for the canonical /ship skill workflow
---

Invoke the project skill `/ship` and follow these canonical references instead of duplicating workflow prose:
