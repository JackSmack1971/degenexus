# prompt-injection-auditor Project Memory
...
> Persistent project memory for the prompt-injection-auditor subagent. Claude Code loads the first 200 lines or 25KB from this file when `memory: project` is declared.
